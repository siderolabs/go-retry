...
#
# Generated on 2022-10-31T18:19:09Z by kres 03328da.
...
RUN FILES="$(goimports -l -local github.com/siderolabs/go-retry .)" && test -z "${FILES}" || (echo -e "Source code is not formatted with 'goimports -w -local github.com/siderolabs/go-retry .':\n${FILES}"; exit 1)
